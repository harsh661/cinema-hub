  ...
  useEffect(() => {
    if (Object.keys(movie).length === 0) {
      ...
      fetch(`https://api.themoviedb.org/3/movie/${params.id}/similar`, options)
        .then((res) => res.json())
        .then((json) => setSimilar(json.results))
        .catch((err) => console.error("error:" + err))
    }
  }, [params.id])
    ...
    <>
      ...
      <Container>
        <div className="py-5 flex">
          ...
          <div className="flex flex-col gap-2 text-dark-text p-0 md:p-5">
        ...
        <div className="text-dark-text font-light py-5 flex flex-col gap-5 lg:text-lg max-w-5xl">
          {movie?.overview}
        </div>
